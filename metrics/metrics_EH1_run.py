# -*- coding: utf-8 -*-
"""
Created on Mon Jul 2 19:12:06 2026

@author: Miriam_Ucendo
@filename: metrics_EH1_run.py
...
ROOT = Path(r"C:\Users\Miriam Ucendo\Documents\UNI\5\TFG_mates\1605136_BSc_Math\metrics\metrics_EH1_run.py").resolve().parents[1]
...
from src.models import EH1_model, EH1_stc_model
...
model_rp = EH1_stc_model(time_periods, 
                         SCENARIOS, 
                         PROB, 
                         params, 
                         DATA, 
...
result = solver.solve(model_rp, tee=False)
