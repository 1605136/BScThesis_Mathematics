...
ROOT = Path(r"C:\Users\Miriam Ucendo\Documents\UNI\5\TFG_mates\1605136_BSc_Math\run\EH1_run.py").resolve().parents[1]
...
output_file = OUTPUT_PATH / f"EH1_results_{study_day}.xlsx"
