...
EH model 2 : CHP, Transformer, Furnace, Absorption Chiller, ESS
...
ROOT = Path(r"C:\Users\Miriam Ucendo\Documents\UNI\5\TFG_mates\1605136_BSc_Math\run\EH2_run.py").resolve().parents[1]
sys.path.insert(0, str(ROOT))


# Import
from src.input_data import load_input_data
from src.models import EH2_model
...
output_file = OUTPUT_PATH / f"EH2_results_{study_day}.xlsx"
...
with pd.ExcelWriter(output_file, mode='w') as writer:
    ...
    for s in SCENARIOS:
        ...
        model = EH2_model(time_periods, PARAMS, DATA, study_day, scenario_day)
