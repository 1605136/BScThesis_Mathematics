...
ROOT = Path(r"C:\Users\Miriam Ucendo\Documents\UNI\5\TFG_mates\1605136_BSc_Math\run\EH2_stc_run.py").resolve().parents[1]
sys.path.insert(0, str(ROOT))


from src.input_data import load_input_data
from src.models import EH2_stc_model
...
output_file = OUTPUT_PATH / f"EH2_stc_results_{study_day}.xlsx"
